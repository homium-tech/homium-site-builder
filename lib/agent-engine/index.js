...
class AgentEngine {
  ...
  executeTurn({ sessionId, message, engine }) {
    ...
    if (isFirstTurnForEngine) {
      ...
      promptText = `[DIRECTIVA HOMIUM: Operas de forma autónoma sin skills externas. El proceso consta de 5 fases canónicas estrictas y finaliza definitivamente en la Fase 5 con el prototipo vanilla HTML/CSS/JS. PROHIBIDO invocar una Fase 6 o frameworks externos (Astro/Next.js). Workspace: ${this.cwd}]. Mensaje del usuario: ${message}`;
    }
